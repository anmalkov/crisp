...
const SelectCatalogRecommendations = ({ recommendations, onClose }) => {

    const recommendationsCategory = useQuery(['catalog-recommendations'], fetchCatalogRecommendations, { staleTime: STALE_TIME });
...
export default SelectCatalogRecommendations;
